...
namespace cyy::compiler {
  ...
  void SDD::add_inherited_attribute(const CFG_production &production,
    ...
    for (auto const &argument : rule.arguments) {
      ...
      if (!std::any_of(production.get_body().begin(),
    production.get_body().end(),
        ...
        throw
    exception::unexisted_grammar_symbol_attribute(argument.get_name());
      }
